...
import (
	...
	usermodel "github.com/muchlist/moneymagnet/business/user/usermodel"
)
...
func (m *MockUserReader) GetByID(ctx context.Context, uuids uuid.UUID) (usermodel.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserReader) GetByIDs(ctx context.Context, uuids []uuid.UUID) ([]usermodel.User, error) {
	m.ctrl.T.Helper()
